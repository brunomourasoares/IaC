...
useradd joao -c "João" -m -s /bin/bash -p $(openssl passwd 123456) -G GRP_ADm

useradd debora -c "Débora" -m -s /bin/bash -p $(openssl passwd 123456) -G GRP_VEN
useradd sebastiao -c "Sebastião" -m -s /bin/bash -p $(openssl passwd 123456) -G GRP_VEN
...
useradd rogerio -c "Rogério" -m -s /bin/bash -p $(openssl passwd 123456) -G GRP_SEC
